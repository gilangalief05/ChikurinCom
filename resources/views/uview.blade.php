    ...
    <div class="container mx-auto my-4 border border-secondary rounded">
        <div class="d-flex">
            ...
            <div class="mx-4 my-auto container-fluid d-block">
                ...
                <div>
                    <!-- <a href="#" class="btn btn-primary w-50 m-1" role="button">Ikuti</a>
                    <a href="#" class="btn btn-outline-primary m-1" role="button">Chat</a> -->
                    <a href="#" class="btn btn-primary w-25 m-1" role="button" data-bs-toggle="button">Edit Akun</a>
    ...
    <div class="container mx-auto my-4">
        <div class="my-2">
            <ul class="nav nav-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Ulasan</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Riwayat Pembelian</a>
                </li>
            </ul>
        </div>
        <div class="m-4">
